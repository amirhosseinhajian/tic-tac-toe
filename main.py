...
def show_info():
    msg_box = QMessageBox(text="""‏‏تیک تاک تو یک بازی ساده اما با این وجود برای مردم در هر سنی هیجان انگیز است.
هر بازیکن نشانه ی خودش را انتخاب می کند-یک ‘X’ یا یک ‘O’- وبعد آنها به نوبت نشانه های خودشان را در مربع های ۳در۳ یا ۱۰در۱۰ پر می کنند.
برنده کسی است که اولین نفری ست که بدون جای خالی به صورت عمودی،افقی یا مورب نشانه های خودش را قرار دهد.
    """)
    msg_box.exec()
...
draw = 0
loader = QUiLoader()
main_window = loader.load("front.ui")
